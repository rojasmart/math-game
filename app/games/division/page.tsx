...
const divisionGames = [
  ...
  {
    id: "leveltwo",
    description: "Find the missing dividend: ? ÷ b = result",
    example: "? ÷ 3 = 4",
  ...
  {
    id: "levelthree",
    description: "Find the missing divisor: 15 ÷ 20 ÷ ? = result",
    example: "15 ÷ 20 ÷ ? = 5",
  ...
  {
    id: "levelfour",
    description: "Chain division problem: a ÷ b ÷ c ÷ ? = result",
    example: "24 ÷ 2 ÷ 3 ÷ ? = 2",
...
export default function DivisionGameMenu() {
  ...
  return (
    <div className="bg-blue-50 min-h-screen p-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-1xl font-bold text-center text-blue-700 mb-6">Division Games</h1>
        <p className="text-lg text-center text-gray-600 mb-8">Choose a game mode to practice different types of division problems.</p>
            ...
            return (
              <div key={game.id} className="relative">
                {isLocked ? (
                  ...
                  <Link href={`/games/division/${game.id}`} className="block no-underline">
