...
export default function SubtractionGameLevelOne() {
  ...
  // Generate new numbers for subtraction
  const generateNumbers = () => {
    let range = 20;
    if (userSettings?.difficulty === "easy") range = 10;
    if (userSettings?.difficulty === "hard") range = 50;

    // Generate numbers ensuring num1 is always greater than num2
    const n2 = Math.floor(Math.random() * range) + 1;
    const n1 = Math.floor(Math.random() * range) + n2; // This ensures n1 ≥ n2
  ...
  return (
    <div className="bg-blue-50 min-h-screen p-8">
      <GameHeader title="Level 1" showPlayAgain={!isActive} onPlayAgain={restartGame} returnPath="/games/subtraction" />
