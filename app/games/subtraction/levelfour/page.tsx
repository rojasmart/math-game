...
export default function SubtractionGameLevelFour() {
  ...
  // Generate new numbers for chain subtraction
  const generateNumbers = () => {
    ...
    const n4 = Math.floor(Math.random() * range) + missing;
    const n3 = Math.floor(Math.random() * range) + n4;
    const n2 = Math.floor(Math.random() * range) + n3;
    const n1 = Math.floor(Math.random() * range) + n2;
    const finalResult = n1 - n2 - n3 - n4 - missing;
  ...
  const checkAnswer = () => {
    ...
    const correctAnswer = num1 - num2 - num3 - num4 - result; // What number, when subtracted, gives us the result
