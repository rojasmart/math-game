...
export default function SubtractionGameLevelTwo() {
  // ...existing code from level one...
  ...
  // Generate new numbers for subtraction with missing subtrahend
  const generateNumbers = () => {
    ...
    const n2 = Math.floor(Math.random() * n1); // Ensure n2 is less than n1
    setNum1(n1);
    setResult(n2);
    setUserAnswer("");
  ...
  const checkAnswer = () => {
    const correctAnswer = num1 - result; // The missing number that gives us the result
  ...
  return (
    <div className="bg-blue-50 min-h-screen p-8">
      <GameHeader title="Level 2" showPlayAgain={!isActive} onPlayAgain={restartGame} returnPath="/games/subtraction" />
