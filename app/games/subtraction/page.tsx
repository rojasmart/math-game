...
export default function SubtractionGameMenu() {
  ...
  return (
    <div className="bg-blue-50 min-h-screen p-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-1xl font-bold text-center text-blue-700 mb-6">Subtraction Games</h1>
        <p className="text-lg text-center text-gray-600 mb-8">Choose a game mode to practice different types of subtraction problems.</p>
            ...
            return (
              <div key={game.id} className="relative">
                {isLocked ? (
                  ...
                  <Link href={`/games/subtraction/${game.id}`} className="block no-underline">
