...
export default function MultiplicationGameLevelTwo() {
  ...
  const generateNumbers = () => {
    ...
    const resultVal = n1 * n2;

    setNum2(n2);
    setResult(resultVal);
    setNum1(n1); // This is the answer but we won't show it
    setUserAnswer("");
  ...
  const checkAnswer = () => {
    ...
    if (userNum === num1) {
      // num1 is our hidden first number
      let timeBonus = 0;
      if (responseTime <= 2) {
  ...
  return (
    <div className="bg-blue-50 min-h-screen p-8">
      <GameHeader title="Level 2" showPlayAgain={!isActive} onPlayAgain={restartGame} returnPath="/games/multiplication" />
