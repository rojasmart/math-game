...
export default function MultiplicationGameLevelOne() {
  ...
  return (
    <div className="bg-blue-50 min-h-screen p-8">
      <GameHeader title="Level 1" showPlayAgain={!isActive} onPlayAgain={restartGame} returnPath="/games/multiplication" />
