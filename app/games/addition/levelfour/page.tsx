...
export default function AdditionGameLevelFour() {
  ...
  const generateProblem = () => {
    ...
    const secondNum = Math.floor(Math.random() * range) + 1;
    const thirdNum = Math.floor(Math.random() * range) + 1;
    const fourthNum = Math.floor(Math.random() * range) + 1;
    const finalResult = firstNum + secondNum + thirdNum + fourthNum + Math.floor(Math.random() * 10) + 1;
    setNum1(firstNum);
    setNum2(secondNum);
    setNum3(thirdNum);
    setNum4(fourthNum);
  ...
  return (
    <div className="bg-blue-50 min-h-screen p-8">
      <GameHeader title="Level 4" showPlayAgain={!isActive} onPlayAgain={restartGame} returnPath="/games/addition" />
          ...
          <div className="bg-white p-8 rounded-xl shadow-md max-w-3xl w-full">
            <div className="flex flex-col md:flex-row gap-8">
              <div className="flex-1">
                ...
                {/* Equation display */}
                <div className="flex justify-center items-center mb-8 text-5xl font-bold">
